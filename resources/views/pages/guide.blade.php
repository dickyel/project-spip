                          ...
                          <div class="profile-data py-3 px-1">
                            <form action="{{ route('update-guide', $guide->id) }}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="mb-3">
                                ...
                                <textarea class="form-control" placeholder="Masukkan deskripsi" id="editor" style="height: 100px" name="description">{{ $guide->description }}</textarea>
                              </div>
                            ...
                            <span>
                              <a href="{{ route('delete-guide', $guide->id) }}" class="btn btn-danger">Hapus</a>
                            </span>
                          </div>
                      </div>
                        ...
                        <div class="profile-data py-3 px-1">
                              <form action="{{ route('save-guide') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" id="judul" aria-describedby="judul" name="guide_title">
